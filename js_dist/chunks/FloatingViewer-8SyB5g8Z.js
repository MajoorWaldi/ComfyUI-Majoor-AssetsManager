import { M as it, c as lt, p as at, q as rt, A as D, t as z, u as B, v as dt, x as ct, y as ut, z as H, E as j, n as pt, s as X, B as Z, C as mt, D as J, F as Q, d as q, G as ht, H as _t } from "./entry-DKHj9LpC.js";
import { ensureViewerMetadataAsset as U } from "./genInfo-B2JYFh9b.js";
...
function pe(t, e, n = {}) {
  ...
  if (t._mode === b.AB || t._mode === b.SIDE || t._mode === b.GRID) {
    ...
    if (t._mode === b.GRID) {
      const r = ["A", "B", "C", "D"].find((u) => !a.has(u)) || "A";
      t[`_media${r}`] = i;
    } else a.has("B") ? t._mediaA = i : t._mediaB = i;
  } else
    t._mediaA = i, t._resetMfvZoom(), t._mode !== b.SIMPLE && (t._mode = b.SIMPLE, t._updateModeBtnUI());
