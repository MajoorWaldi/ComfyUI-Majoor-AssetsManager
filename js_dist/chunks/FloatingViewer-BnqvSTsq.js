import { s as j, t as S, E as T, n as te, a as U, b as V, e as G, g as z, c as $, i as W, d as ie, h as ne, M as se, j as oe, k as re, l as le, A as ae } from "./entry-DIIk4hwW.js";
const g = Object.freeze({
  SIMPLE: "simple",
  AB: "ab",
  SIDE: "side",
  GRID: "grid"
}), X = 0.25, K = 8, de = 8e-4, H = 8;
let ce = 0;
const he = /* @__PURE__ */ new Set([".mp4", ".webm", ".mov", ".avi", ".mkv"]), pe = /* @__PURE__ */ new Set([".mp3", ".wav", ".flac", ".ogg", ".m4a", ".aac", ".opus", ".wma"]), ue = "C", q = "L", Z = "K", me = "N", _e = "Esc";
function fe() {
  var u, e, t, n, o;
  try {
...
function k(u) {
  ...
  const t = ge((u == null ? void 0 : u.filename) || "");
  return t === ".gif" ? "gif" : he.has(t) ? "video" : pe.has(t) ? "audio" : se.has(t) ? "model3d" : "image";
}
function Q(u) {
...
function D(u, { fill: e = !1 } = {}) {
  ...
  if (n === "model3d")
    return oe(u, t, {
      ...
      pauseDuringExecution: !!ae.FLOATING_VIEWER_PAUSE_DURING_EXECUTION
    });
...
class Ce {
  ...
  _buildHeader() {
    ...
    this._closeBtn = n, n.type = "button", n.className = "mjr-icon-btn", j(n, S("tooltip.closeViewer", "Close viewer"), _e);
  ...
  _buildToolbar() {
    ...
    const t = document.createElement("div");
    t.className = "mjr-mfv-toolbar-sep", t.setAttribute("aria-hidden", "true"), e.appendChild(t), this._liveBtn = document.createElement("button"), this._liveBtn.type = "button", this._liveBtn.className = "mjr-icon-btn", this._liveBtn.innerHTML = '<i class="pi pi-circle" aria-hidden="true"></i>', this._liveBtn.setAttribute("aria-pressed", "false"), j(
      this._liveBtn,
      S("tooltip.liveStreamOff", "Live Stream: OFF — click to follow"),
      q
    ), e.appendChild(this._liveBtn), this._previewBtn = document.createElement("button"), this._previewBtn.type = "button", this._previewBtn.className = "mjr-icon-btn", this._previewBtn.innerHTML = '<i class="pi pi-eye" aria-hidden="true"></i>', this._previewBtn.setAttribute("aria-pressed", "false"), j(
      this._previewBtn,
      S(
      ...
      Z
    ), e.appendChild(this._previewBtn), this._nodeStreamBtn = document.createElement("button"), this._nodeStreamBtn.type = "button", this._nodeStreamBtn.className = "mjr-icon-btn", this._nodeStreamBtn.innerHTML = '<i class="pi pi-sitemap" aria-hidden="true"></i>', this._nodeStreamBtn.setAttribute("aria-pressed", "false"), j(
      this._nodeStreamBtn,
  ...
  _getGenFields(e) {
    ...
    try {
      ...
      if (a && typeof a == "object") {
        a.prompt && (d.prompt = U(String(a.prompt))), a.seed != null && (d.seed = String(a.seed)), a.model && (d.model = Array.isArray(a.model) ? a.model.join(", ") : String(a.model)), Array.isArray(a.loras) && (d.lora = a.loras.map(
          (p) => typeof p == "string" ? p : (p == null ? void 0 : p.name) || (p == null ? void 0 : p.lora_name) || (p == null ? void 0 : p.model_name) || ""
        ).filter(Boolean).join(", ")), a.sampler && (d.sampler = String(a.sampler)), a.scheduler && (d.scheduler = String(a.scheduler)), a.cfg != null && (d.cfg = String(a.cfg)), a.steps != null && (d.step = String(a.steps)), !d.prompt && (s != null && s.prompt) && (d.prompt = U(String(s.prompt || "")));
  ...
  _updateModeBtnUI() {
    ...
    }, { icon: t = "pi-image", label: n = "" } = e[this._mode] || {}, o = V(n, ue), i = document.createElement("i");
  ...
  setLiveActive(e) {
    ...
    const n = t ? S("tooltip.liveStreamOn", "Live Stream: ON — click to disable") : S("tooltip.liveStreamOff", "Live Stream: OFF — click to follow"), o = V(n, q);
    ...
    e.addEventListener(
      ...
      (s) => {
        ...
        if (a && ve(
          ...
          return;
        s.preventDefault();
        const m = 1 - (s.deltaY || s.deltaX || 0) * de;
  ...
  _renderSimple() {
    ...
    const e = k(this._mediaA), t = D(this._mediaA);
    if (!t) {
  ...
  _renderAB() {
    var h;
    const e = this._mediaA ? D(this._mediaA, { fill: !0 }) : null, t = this._mediaB ? D(this._mediaB, { fill: !0 }) : null, n = this._mediaA ? k(this._mediaA) : "", o = this._mediaB ? k(this._mediaB) : "";
    if (!e && !t) {
    ...
    s.addEventListener(
      ...
      (f) => {
        ...
        const w = _.signal, v = i.getBoundingClientRect(), b = (M) => {
          ...
          this._abDividerX = y;
          const E = Math.round(y * 100);
          l.style.clipPath = `inset(0 0 0 ${E}%)`, s.style.left = `${E}%`, d && (d.style.right = `calc(${100 - E}% + 8px)`), p && (p.style.left = `calc(${E}% + 8px)`);
        }, A = () => {
          try {
            _ == null || _.abort();
          } catch {
    ...
    ), i.appendChild(r), i.appendChild(l), i.appendChild(s), d && i.appendChild(d), p && i.appendChild(p), i.appendChild(x("A", "left")), i.appendChild(x("B", "right")), this._contentEl.appendChild(i);
  }
  _renderSide() {
    const e = this._mediaA ? D(this._mediaA) : null, t = this._mediaB ? D(this._mediaB) : null, n = this._mediaA ? k(this._mediaA) : "", o = this._mediaB ? k(this._mediaB) : "";
    if (!e && !t) {
    ...
    const r = document.createElement("div");
    r.className = "mjr-mfv-side-panel", e ? r.appendChild(e) : r.appendChild(P("—")), r.appendChild(x("A", "left"));
    ...
    const c = document.createElement("div");
    c.className = "mjr-mfv-side-panel", t ? c.appendChild(t) : c.appendChild(P("—")), c.appendChild(x("B", "right"));
  ...
  popOut() {
    ...
    const t = fe(), n = typeof window < "u" && "documentPictureInPicture" in window, o = String(((l = window == null ? void 0 : window.navigator) == null ? void 0 : l.userAgent) || ((c = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : c.userAgent) || ""), i = Math.max(e.offsetWidth || 520, 400), r = Math.max(e.offsetHeight || 420, 300);
    if (C("start", {
      isElectronHost: t,
      hasDocumentPiP: n,
      userAgent: o,
  ...
  _fallbackPopout(e, t, n) {
    ...
    l.addEventListener("beforeunload", s, { signal: c }), l.addEventListener("pagehide", s, { signal: c }), l.addEventListener("unload", s, { signal: c }), this._startPopoutCloseWatch(), this._popoutKeydownHandler = (h) => {
      ...
      if (String((h == null ? void 0 : h.key) || "").toLowerCase() === "v" && (h != null && h.ctrlKey || h != null && h.metaKey) && !(h != null && h.altKey) && !(h != null && h.shiftKey)) {
        h.preventDefault(), (A = h.stopPropagation) == null || A.call(h), (M = h.stopImmediatePropagation) == null || M.call(h), this._dispatchControllerAction("toggle", T.MFV_TOGGLE);
        return;
      }
  ...
  _drawGenInfoOverlay(e, t, n, o, i, r) {
    ...
    for (const y of s) {
      ...
      const E = l[y] != null ? String(l[y]) : "";
      if (!E) continue;
      let B = y.charAt(0).toUpperCase() + y.slice(1);
      y === "lora" ? B = "LoRA" : y === "cfg" ? B = "CFG" : y === "genTime" && (B = "Gen Time");
      const N = E;
      a.push({
        label: `${B}: `,
        value: N,
    ...
    e.save();
    const h = [];
    for (const { label: y, value: E, color: B } of a) {
      ...
      I && R.push(I), h.push({ label: y, labelW: N, lines: R, color: B });
    }
    const f = h, v = h.reduce((y, E) => y + E.lines.length, 0) * m + p * 2, b = n + p, A = o + r - v - p;
    e.globalAlpha = 0.72, e.fillStyle = "#000", ee(e, b, A, _, v, 6), e.fill(), e.globalAlpha = 1;
    let M = A + p + d;
    for (const { label: y, labelW: E, lines: B, color: N } of f)
      for (let L = 0; L < B.length; L++)
        L === 0 ? (e.font = `bold ${d}px system-ui, sans-serif`, e.fillStyle = N, e.fillText(y, b + p, M), e.font = `${d}px system-ui, sans-serif`, e.fillStyle = "rgba(255,255,255,0.88)", e.fillText(B[L], b + p + E, M)) : (e.font = `${d}px system-ui, sans-serif`, e.fillStyle = "rgba(255,255,255,0.88)", e.fillText(B[L], b + p + E, M)), M += m;
    e.restore();
  }
  ...
  async _captureView() {
    ...
    try {
      if (this._mode === g.SIMPLE)
        ...
        this._mediaA && await this._drawMediaFit(i, this._mediaA, 0, 0, e, n, a), this._mediaB && (i.save(), i.beginPath(), i.rect(s, 0, e - s, n), i.clip(), await this._drawMediaFit(i, this._mediaB, 0, 0, e, n, d), i.restore()), i.save(), i.strokeStyle = "rgba(255,255,255,0.88)", i.lineWidth = 2, i.beginPath(), i.moveTo(s, 0), i.lineTo(s, n), i.stroke(), i.restore(), F(i, "A", 8, 8), F(i, "B", s + 8, 8), this._mediaA && this._drawGenInfoOverlay(i, this._mediaA, 0, 0, s, n), this._mediaB && this._drawGenInfoOverlay(i, this._mediaB, s, 0, e - s, n);
        ...
        this._mediaA && (await this._drawMediaFit(i, this._mediaA, 0, 0, s, n, a), this._drawGenInfoOverlay(i, this._mediaA, 0, 0, s, n)), i.fillStyle = "#111", i.fillRect(s, 0, 2, n), this._mediaB && (await this._drawMediaFit(i, this._mediaB, s, 0, s, n, d), this._drawGenInfoOverlay(i, this._mediaB, s, 0, s, n)), F(i, "A", 8, 8), F(i, "B", s + 8, 8);
        ...
        for (let _ = 0; _ < m.length; _++) {
          ...
          h.media && (await this._drawMediaFit(i, h.media, h.x, h.y, h.w, h.h, f), this._drawGenInfoOverlay(i, h.media, h.x, h.y, h.w, h.h)), F(i, h.label, h.x + 8, h.y + 8);
        }
