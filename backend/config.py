...
DB_QUERY_TIMEOUT = env_float("MAJOOR_DB_QUERY_TIMEOUT", 60.0)
...
WATCHER_DEFAULT_DEBOUNCE_MS = _env_int("MJR_WATCHER_DEBOUNCE_MS", 3000)
...
WATCHER_MAX_FILE_SIZE_BYTES = _env_int(
    ...
    _env_int("MAJOOR_WATCHER_MAX_FILE_SIZE", 512 * 1024 * 1024),
)
WATCHER_MIN_FILE_SIZE_BYTES = _env_int(
    "MJR_WATCHER_MIN_FILE_SIZE_BYTES",
    _env_int("MAJOOR_WATCHER_MIN_FILE_SIZE", 100),
)
...
WATCHER_PENDING_MAX = _env_int(
    ...
    _env_int("MAJOOR_WATCHER_MAX_PENDING_FILES", 500),
)
...
SCAN_BATCH_INITIAL = _env_int("MAJOOR_SCAN_BATCH_INITIAL", 1000)
SCAN_BATCH_MIN = _env_int("MAJOOR_SCAN_BATCH_MIN", 100)
