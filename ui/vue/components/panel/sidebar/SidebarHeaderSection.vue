...
<template>
    <div
        ...
        style="display:flex;align-items:center;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--mjr-border,rgba(255,255,255,0.12));flex-shrink:0;background:var(--mjr-surface-2,#2e2e2e)"
    >
        <div
